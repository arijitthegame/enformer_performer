...
from performer.tf_version.fast_attention import create_projection_matrix,  softmax_kernel_transformation, causal_denominator, noncausal_denominator, causal_numerator, noncausal_numerator 
from performer.tf_version.fast_attention_sonnet import *
